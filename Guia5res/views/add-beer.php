            ...
            <tbody align="center">
              <tr>
                <td style="max-width: 120px;">    
                  <input type="number" name="beerCode" size="22" min="0" required>
                </td>
                <td>
                  <input type="text" name="name" size="22" required>
                </td>
                <td>
                  <select name="beerType" style="margin-top: 3%;min-height: 35px;height: 20px" required>
                  <?php 
                    if(isset($beerTypeList))
                    {
                      ...
                      {                    
                  ?>
                    <option value="<?php echo $beerType->getBeerTypeCode() ?>"><?php echo $beerType->getName() ?></option>
                    <?php 
                      }
                    }
                    ?>
